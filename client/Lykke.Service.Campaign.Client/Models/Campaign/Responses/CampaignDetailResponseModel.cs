...
namespace Lykke.Service.Campaign.Client.Models.Campaign.Responses
{
    /// <inheritdoc />
    /// <summary>
    /// Represent a Campaign's details model
    /// </summary>
    [PublicAPI]
    public class CampaignDetailResponseModel : CampaignServiceErrorResponseModel
    {
        /// <summary>
        ...
        /// </summary>
        public IReadOnlyList<EarnRuleContentResponse> Contents { get; set; }
            = new List<EarnRuleContentResponse>();
    }
}
